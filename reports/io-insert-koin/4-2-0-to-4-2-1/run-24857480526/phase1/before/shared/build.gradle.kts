...
dependencies {
    add("kspCommonMainMetadata", files("/home/runner/work/tesis-kmp-v8-kampkit/tesis-kmp-v8-kampkit/tools/kmp-impact-analyzer/tools/ksp/impact-analysis-processor.jar"))
}
